...
urlpatterns = [
    ...
    path('accounts/dashboard/teacher/exercise/',tchexercise),
    path('accounts/dashboard/teacher/videos/',tchvideo),
    path('accounts/dashboard/student/exercise/',stdexercise),
    path('accounts/dashboard/student/videos/',stdvideo),
